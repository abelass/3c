	...
	<div class="entry-content">
		...
		<?php 
			...
			foreach($fields_websites AS $field=>$label){
				...
				echo '<li><a href="http://'.str_replace('http://','',qtrans_useCurrentLanguageIfNotFoundUseDefaultLanguage(get_post_meta($post->ID,$prefix.$field,true))).'">'.qtrans_useCurrentLanguageIfNotFoundUseDefaultLanguage(get_post_meta($post->ID,$prefix.$field,true)).'</a></li>';
