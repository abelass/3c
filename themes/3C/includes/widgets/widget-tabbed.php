...
<div id="tabbed" class="sidebar-block">
	<ul id="tabbed-area" class="clearfix">
		<li class="first"><a href="#recent-tabbed"><?php esc_html_e('Recent','3C'); ?></a></li>
		<li class="second"><a href="#popular-tabbed"><?php esc_html_e('Popular','3C'); ?></a></li>
		<li class="last"><a href="#random-tabbed"><?php esc_html_e('Random','3C'); ?></a></li>
	</ul>
	
	<div id="recent-tabbed" class="widget">
		<h3 class="widgettitle"><?php esc_html_e('From the Blog','3C'); ?></h3>
		<ul>
	...
	<div id="popular-tabbed" class="widget">
		<h3 class="widgettitle"><?php esc_html_e('Popular','3C'); ?></h3>
		<ul>
			<?php global $wpdb;
	...
	<div id="random-tabbed" class="widget">
		<h3 class="widgettitle"><?php esc_html_e('Random','3C'); ?></h3>
		<ul>
