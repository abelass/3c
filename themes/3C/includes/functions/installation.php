 <span class="boldtext">1. How do I install 3C onto my wordpress blog? </span> 
<div class="indent"> 
...
<p>Next you will need to assign an Icon image to each blurb. This works just like Thumbnail images, except you use the custom field name "Icon" instead. So create a custom field for each page with the name of "Icon" and a value of the icon image you would like to use. Icons must not exceed 36x36 pixels to insure optimum display.</p> 
  ...
  <span class="boldtext">8. How do I add descriptions to the pages on the homepage? </span> 
  <div class="indent"> 
  <p>Descriptions appear below the title on pages on the homepage. To add this description simply create a custom field for each post/page with the name of "Tagline" and a value of the text you would like to use for the description.
</p> 
</div> 