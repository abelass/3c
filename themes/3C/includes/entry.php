...
if (have_posts()) : while (have_posts()) : the_post(); ?>
	...
	<h2 class="title<?php if ($page_result) echo(' page_result'); ?>"><a href="<?php the_permalink() ?>" title="<?php printf(esc_attr__ ('Permanent Link to %s', '3C'), $titletext) ?>"><?php the_title(); ?></a></h2>
	...
	<?php if($thumb <> '' && get_option('minimal_thumbnails_index') == 'on') { ?>
		<a href="<?php the_permalink() ?>" title="<?php printf(esc_attr__ ('Permanent Link to %s', '3C'), $titletext) ?>">
	...
	<?php }; ?>
	<a class="readmore" href="<?php the_permalink(); ?>"><span><?php esc_html_e('Read More','3C'); ?></span></a>
	<div class="clear"></div>
<?php endwhile; ?>		
