					...
					<div id="et_pt_blog">
						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<div class="et_pt_blogentry clearfix">
								...
								<p class="et_pt_blogmeta"><?php esc_html_e('Posted','3C'); ?> <?php esc_html_e('by','3C'); ?> <?php the_author_posts_link(); ?> <?php esc_html_e('on','3C'); ?> <?php the_time(get_option('minimal_date_format')) ?> <?php esc_html_e('in','3C'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(esc_html__('0 comments','3C'), esc_html__('1 comment','3C'), '% '.esc_html__('comments','3C')); ?></p>
								...
								<?php if (!$et_ptemplate_blogstyle) { ?>
									...
									<a href="<?php the_permalink(); ?>" class="readmore"><span><?php esc_html_e('read more','3C'); ?></span></a>
								<?php } else { ?>
									<?php
										global $more;
										$more = 0;
