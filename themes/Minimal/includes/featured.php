<!-- Start Featured -->	
	<div id="featured" class="clearfix">
		<a href="#" id="left_arrow"><?php _e('Previous','Minimal') ?></a>
		<a href="#" id="right_arrow"><?php _e('Next','Minimal') ?></a>
	...
	<!-- Featured Content -->
		<div id="featured_content"> 
			...
			$featured_num = get_option('minimal_featured_num');
			...
			if (get_option('minimal_use_pages') == 'false') query_posts("showposts=$featured_num&cat=".get_catId($featured_cat));
				...
				query_posts(array
								...
								'orderby' => 'menu_order',
								'order' => 'ASC',
								'post__in' => get_option('minimal_feat_pages'),
